export default function Footer() {
  ...
  return (
    <footer className="p-5 sm:p-8 border-t border-white/5">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="p-2 sm:p-3 bg-white/5 hover:bg-indigo-500/10 text-gray-400 hover:text-indigo-400 rounded-xl border border-white/5 transition-all duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 sm:p-3 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-xl border border-white/5 transition-all duration-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 sm:p-3 bg-white/5 hover:bg-sky-500/10 text-gray-400 hover:text-sky-400 rounded-xl border border-white/5 transition-all duration-300"
            >
